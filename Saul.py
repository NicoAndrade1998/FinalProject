...
def multi(Mytokens, box3, box4, depth):
  print("\n----parent node multi, finding children nodes:")
  box3.insert(END, "\n----parent node multi, finding children nodes:\n")
  box4.insert('math', 'end', 'multi' + str(depth), text= 'multi')
  global inToken
  if (inToken[0] == "float"):
    print("child node (internal): float")
    ...
    box4.insert('multi' + str(depth), 'end', 'float', text= 'float: ' + inToken[1])
    accept_token(Mytokens, box3, box4)
  elif (inToken[0] == "int"):
    print("child node (internal): int")
    ...
    if (inToken[1] == "*"):
      ...
      box4.insert('multi' + str(depth), 'end', '*', text= '*')
      multi(Mytokens, box3, box4, depth + 1)
    else:
      print("error, you need * after the int in the math")
